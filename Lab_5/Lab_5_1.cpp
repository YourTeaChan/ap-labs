...
//Варіант 1: задавання кількості параметрів.
...
void Function_1(char *letter, int kst, char* sentence, ...);
...
int main()
{
	...
	printf("\n-------------------------------------------------------\nВаріант 1\n");
	Function_1(letter, kst, sentence_1, sentence_2, sentence_3, sentence_4);
	return 0;
}
